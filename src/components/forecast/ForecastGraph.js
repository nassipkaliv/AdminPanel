...
class ForecastGraph extends React.Component {
  constructor(props) {
    super(props);
  ...
  componentDidMount() {
    ...
    const ForecastUsersOverview = new Chart(this.canvasRef.current, {
      type: "LineWithLine",
    ...
    const buoMeta = ForecastUsersOverview.getDatasetMeta(0);
        ...
        <CardHeader className="">
          <Row className="d-flex align-items-center bg-light"> {/* Added d-flex and align-items-center */}
            <Col lg={7} className="d-flex align-items-center">
              <h2 style={{ color: 'var(--black, #1D2226)' }}>Stock/Coin/Analytic</h2>
            </Col>
